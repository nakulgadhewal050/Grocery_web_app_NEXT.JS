...
function GroceryItemCard({ item, isAboveTheFold = false }: { item: IGrocery; isAboveTheFold?: boolean }) {
    ...
    return (
        ...
        >
            ...
            <div className="p-4 flex flex-col flex-1">
                ...
                {!cartItem ? (
                    <motion.button
                        className="mt-4 flex items-center justify-center gap-2 bg-green-600 text-white py-2 rounded-full hover:bg-green-700 text-sm font-medium transition-all cursor-pointer"
                    ...
                    <motion.div
                        ...
                        className="mt-4 flex items-center justify-center gap-4 bg-green-100 border border-green-200 rounded-full  text-green-700 py-2 px-4 "
                    >

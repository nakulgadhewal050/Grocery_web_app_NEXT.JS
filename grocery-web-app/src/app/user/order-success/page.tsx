...
function OrderSucess() {
  return (
    <div className="flex flex-col items-center justify-center text-center px-6 min-h-[80vh]">
      ...
      >
        Thank you for shopping with us. We are processing your order. You can
        track its progress in your{" "}
      ...
      >
        <Link href="/user/my-orders">
          <motion.button
            ...
            transition={{ duration: 0.4, delay: 1.2 }}
            whileTap={{ scale: 0.96 }}
            className="flex items-center bg-green-600 text-white text-base font-semibold py-3 px-8 rounded-full shadow-lg hover:bg-green-700 transition-colors cursor-pointer"
          >
